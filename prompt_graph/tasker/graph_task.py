...
from prompt_graph.utils import center_embedding, Gprompt_tuning_loss, constraint, contrastive_loss, drop_feature
from prompt_graph.evaluation import GpromptEva, GNNGraphEva, GPFEva, AllInOneEva, GPPTGraphEva, denoisedPromptEva
import time
import os 
import numpy as np
...
class GraphTask(BaseTask):
    ...
    def linear_probe_train(self, train_loader):
        self.gnn.eval()
    ...
    def denoisedPromptTrain(self, train_loader):
        ...
        for batch in train_loader:
            ...
            loss = loss_task + 0.1 * loss_privacy
            loss.backward()
            self.pg_opi.step()
            total_loss += loss.item()
            ...
            for i in range(1, 6):
                ...
                for epoch in range(1, self.epochs + 1):
                    ...
                    if self.prompt_type == 'None':
                        loss = self.linear_probe_train(train_loader)
