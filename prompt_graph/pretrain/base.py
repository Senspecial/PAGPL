...
class PreTrain(torch.nn.Module):
    def __init__(self, epsilon, delta, gnn_type='TransformerConv', dataset_name = 'Cora', input_dim=128, hid_dim = 128, gln = 2, num_epoch = 1000, device : int = 5, graph_list=None, num_workers=0):
        super().__init__()
