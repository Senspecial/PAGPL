...
def get_args():
    ...
    parser.add_argument("--pretrain_task", type=str, default="DGI")
    parser.add_argument("--downstream_task", type=str, default="NodeTask")
    ...
    parser.add_argument("--gnn_weight", type=float, default=0.00001)
    parser.add_argument(
        "--dataset_name",
        type=str,
        default="Cora",
    ...
    parser.add_argument(
        ...
        type=str,
        default="/root/autodl-tmp/ProG/Experiment/pre_trained_model/CiteSeer/DGI.GCN.128hidden_dim.pth",
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="The number of tasks for computing the mean metrics",
    )
